...
public class QuestionNumber {
    ...
    public String visitQuestionNumber(TLParser.NumberQuestionContext ctx, SymbolTable symbolTable){
    ...
    public String printBody(TLParser.NumberQuestionContext ctx, SymbolTable symbolTable){
        int numberCount = 0;
        int textCount = 0;
        int addCount = 0;
        int varCount = 1;
